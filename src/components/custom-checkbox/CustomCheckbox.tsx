...
export const CustomCheckbox: FC<CustomCheckboxProps> = ({leftSideText, rightSideText, checkName}) => {
    ...
    return (
        <>
            ...
            <input type="checkbox" id={"isNew"} {...register(checkName)} className={style.check}/>
        </>
    )
}